...
function ma(a){switch(a.status){case "resolved_model":K(a);break;case "resolved_module":L(a)}switch(a.status){case "fulfilled":return a.value;case "pending":case "blocked":case "cyclic":throw a;default:throw a.reason;}}function M(a,b){for(var c=0;c<a.length;c++)(0,a[c])(b)}function N(a,b,c){switch(a.status){case "fulfilled":M(b,a.value);break;case "pending":case "blocked":case "cyclic":a.value=b;a.reason=c;break;case "rejected":c&&M(c,a.reason)}}
...
function na(a,b,c,d){if(R){var f=R;d||f.deps++}else f=R={deps:d?0:1,value:null};return function(h){b[c]=h;f.deps--;0===f.deps&&"blocked"===a.status&&(h=a.value,a.status="fulfilled",a.value=f.value,null!==h&&M(h,f.value))}}function oa(a){return function(b){return O(a,b)}}
function pa(a,b){function c(){var f=Array.prototype.slice.call(arguments),h=b.bound;return h?"fulfilled"===h.status?d(b.id,h.value.concat(f)):Promise.resolve(h).then(function(e){return d(b.id,e.concat(f))}):d(b.id,f)}var d=a._callServer;H(c,b);return c}function U(a,b){a=T(a,b);switch(a.status){case "resolved_model":K(a)}switch(a.status){case "fulfilled":return a.value;default:throw a.reason;}}
function qa(a,b,c,d){if("$"===d[0]){if("$"===d)return B;switch(d[1]){case "$":return d.slice(1);case "L":return b=parseInt(d.slice(2),16),a=T(a,b),{$$typeof:ea,_payload:a,_init:ma};case "@":return b=parseInt(d.slice(2),16),T(a,b);case "S":return Symbol.for(d.slice(2));case "P":return a=d.slice(2),I[a]||(b={$$typeof:da,_currentValue:C,_currentValue2:C,_defaultValue:C,_threadCount:0,Provider:null,Consumer:null,_globalName:a},b.Provider={$$typeof:ca,_context:b},I[a]=b),I[a].Provider;case "F":return b=
parseInt(d.slice(2),16),b=U(a,b),pa(a,b);case "Q":return b=parseInt(d.slice(2),16),a=U(a,b),new Map(a);case "W":return b=parseInt(d.slice(2),16),a=U(a,b),new Set(a);case "I":return Infinity;case "-":return"$-0"===d?-0:-Infinity;case "N":return NaN;case "u":return;case "D":return new Date(Date.parse(d.slice(2)));case "n":return BigInt(d.slice(2));default:d=parseInt(d.slice(1),16);a=T(a,d);switch(a.status){case "resolved_model":K(a);break;case "resolved_module":L(a)}switch(a.status){case "fulfilled":return a.value;
case "pending":case "blocked":case "cyclic":return d=Q,a.then(na(d,b,c,"cyclic"===a.status),oa(d)),null;default:throw a.reason;}}}return d}function ra(){throw Error('Trying to call a function from "use server" but the callServer option was not implemented in your router runtime.');}
function V(a,b,c,d){var f=new Map;a={_bundlerConfig:a,_moduleLoading:b,_callServer:void 0!==c?c:ra,_nonce:d,_chunks:f,_stringDecoder:new TextDecoder,_fromJSON:null,_rowState:0,_rowID:0,_rowTag:0,_rowLength:0,_buffer:[]};a._fromJSON=sa(a);return a}function W(a,b,c){a._chunks.set(b,new J("fulfilled",c,null,a))}
...
"resolved_model",c.value=e,null!==a&&(K(c),N(c,a,b))):d.set(b,new J("resolved_model",e,null,a))}}function sa(a){return function(b,c){return"string"===typeof c?qa(a,this,b,c):"object"===typeof c&&null!==c?(b=c[0]===B?{$$typeof:B,type:c[1],key:c[2],ref:null,props:c[3],_owner:null}:c,b):c}}
...
48);continue;case 3:m=e.indexOf(10,l);break;case 4:m=l+n,m>e.length&&(m=-1)}var t=e.byteOffset+l;if(-1<m)n=new Uint8Array(e.buffer,t,m-l),ua(a,h,g,v,n),l=m,3===k&&l++,n=h=g=k=0,v.length=0;else{e=new Uint8Array(e.buffer,t,e.byteLength-l);v.push(e);n-=e.byteLength;break}}a._rowState=k;a._rowID=h;a._rowTag=g;a._rowLength=n;return f.read().then(c).catch(d)}}function d(h){S(a,h)}var f=b.getReader();f.read().then(c).catch(d)}
...
exports.encodeReply=function(a){return new Promise(function(b,c){la(a,"",b,c)})};
=======
