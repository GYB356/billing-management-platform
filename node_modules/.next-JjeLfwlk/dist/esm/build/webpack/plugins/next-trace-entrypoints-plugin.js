...
=======
import { CLIENT_REFERENCE_MANIFEST, TRACE_OUTPUT_VERSION, UNDERSCORE_NOT_FOUND_ROUTE_ENTRY } from "../../../shared/lib/constants";
import { webpack, sources } from "next/dist/compiled/webpack/webpack";
import { NODE_ESM_RESOLVE_OPTIONS, NODE_RESOLVE_OPTIONS } from "../../webpack-config";
import { loadBindings } from "../../swc";
...
=======
                    const clientManifestsForPage = entrypoint.name.endsWith("/page") || entrypoint.name === UNDERSCORE_NOT_FOUND_ROUTE_ENTRY ? nodePath.join(outputPath, "..", entrypoint.name.replace(/%5F/g, "_") + "_" + CLIENT_REFERENCE_MANIFEST + ".js") : null;
>>>>>>> 4f9d35bd5c5bf095848f6fc99f7e7bfe5212365f
