...
<<<<<<< HEAD
    ...
    .filter((request)=>isServer ? !_utils.regexCSS.test(request) : true).map((request)=>`import(/* webpackMode: "eager" */ ${JSON.stringify(request.startsWith(_constants.BARREL_OPTIMIZATION_PREFIX) ? request.replace(":", "!=!") : request)})`).join(";\n");
=======
