...
function ca(a){for(var b=a[1],c=[],d=0;d<b.length;d++){var e=b[d],g=u.get(e);if(void 0===g){g=globalThis.__next_chunk_load__(e);c.push(g);var f=u.set.bind(u,e,null);g.then(f,ba);u.set(e,g)}else null!==g&&c.push(g)}return 4===a.length?0===c.length?v(a[0]):Promise.all(c).then(function(){return v(a[0])}):0<c.length?Promise.all(c):null}
function da(a,b,c){if(null!==a)for(var d=0;d<b.length;d++){var e=c,g=x.current;if(g){var f=g.preinitScript,l=a.prefix+b[d];var h=a.crossOrigin;h="string"===typeof h?"use-credentials"===h?h:"":void 0;f.call(g,l,{crossOrigin:h,nonce:e})}}}
