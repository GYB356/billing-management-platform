...
<<<<<<< HEAD
    ...
    .filter((request)=>isServer ? !regexCSS.test(request) : true).map((request)=>`import(/* webpackMode: "eager" */ ${JSON.stringify(request.startsWith(BARREL_OPTIMIZATION_PREFIX) ? request.replace(":", "!=!") : request)})`).join(";\n");
=======
