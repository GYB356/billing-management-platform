                            ...
                            case "span-end":
                                {
                                    new _trace.Span({
                                        ...
                                        startTime: BigInt(Math.floor(parsedData.startTime)) * BigInt(MILLISECONDS_IN_NANOSECOND),
                                        attrs: parsedData.attributes
                                    }).stop(BigInt(Math.floor(parsedData.endTime)) * BigInt(MILLISECONDS_IN_NANOSECOND));
                                    break;
                                }
                            case "client-error":
                            case "client-warning":
