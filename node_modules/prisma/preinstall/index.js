...
var white2 = (str) => WHITE_BRIGHT + str + RESET;
function main() {
  ...
  if (installedGlobally.name === "prisma2") {
    message = `
The package ${white2("prisma2")} has been renamed to ${white2("prisma")}.

Please uninstall ${white2("prisma2")} globally first.
Then install ${white2("prisma")} to continue using ${b("Prisma 2+")}:

   # Uninstall old CLI
   ${white2(installedGlobally.pkgManager === "yarn" ? "yarn global remove prisma2" : "npm uninstall -g prisma2")}

   # Install new CLI
   ${white2(`npm install prisma${isDev ? "@dev" : ""} --save-dev`)}

   # Invoke via npx
   ${white2("npx prisma --help")}
